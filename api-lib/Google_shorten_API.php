...
class Google_Shorten
{
	...
	function expandURL($shortURL) {
		$params = 'key='.$this->_APIKEY.'&shortUrl='.$shortURL.'&projection='.$this->_projection;
		$ch = curl_init();
		curl_setopt($ch, CURLOPT_URL, 'https://www.googleapis.com/urlshortener/v1/url?'.$params);
